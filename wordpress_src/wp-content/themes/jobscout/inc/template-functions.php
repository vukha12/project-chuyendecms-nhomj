...
if (! function_exists('jobscout_header')) :
    ...
    <?php
        ...
        if (! function_exists('jobscout_footer_subscribe')) :
            ...
            { ?>
        <div class="footer-t footer-subscribe-t" style="height: 150px;">
            <div class="container">
                <div class="subscribe-wrapper">
                    <?php echo do_shortcode('[contact-form-7 id="ca6a504" title="contact form 2"]'); ?>
                </div>
            </div>
        </div>
    ...
    <?php }
        ...
        add_action('jobscout_footer', 'jobscout_footer_top', 30); // priority 30 → chạy sau
