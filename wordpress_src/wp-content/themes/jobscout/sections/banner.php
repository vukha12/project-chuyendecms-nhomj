...
$banner_subtitle   = get_theme_mod('banner_subtitle', __('', 'jobscout'));
            ...
            <div class="banner-caption">
                <div class="container">
                    <div class="caption-inner" style="text-align: left;">
                        <?php
                        $text_style = 'color: #ffffff; text-shadow: 2px 2px 4px #000000, 0 0 10px #000000;';

                        if ($banner_title) echo '<h2 class="title" style="color: #ffffff; text-shadow: 2px 2px 4px #000000, 0 0 10px #000000;">' . esc_html($banner_title) . '</h2>';
                        if ($banner_subtitle) echo '<div class="description" style="color: #ffffff; text-shadow: 2px 2px 4px #000000, 0 0 10px #000000;">' . wpautop(wp_kses_post($banner_subtitle)) . '</div>';
                        ?>
                        <div class="form-wrap">
